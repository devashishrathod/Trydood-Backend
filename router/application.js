...
const { getAllState, addState, updateState, deleteState, getAllHome, getOne, addHomeApplication, updateHomeApplication, deleteHomeApplication, getDealOfCategories, getDealOfDayPagination, addDealOfCategory, updateDealOfCategory, deleteDealOfCategory, getAllPrivacy, getSinglePrivacy, addPrivacy, updatePrivacy, deletePrivacy, getAllFilter, addFilter, updateFilter, deleteFilter, pagination, getAllRefundPolicy, getSingleRefundPolicy, addRefundPolicy, updateRefundPolicy, deleteRefundPolicy, getAllTerms, getSingleTerms, addTerms, updateTerms, deleteTerms } = require('../controller/application')
...
// ================================= filter ===================================
applicationRouter.get('/filter/getAll', getAllFilter)
applicationRouter.get('/filter/getOne/:id', getAllFilter)
applicationRouter.get('/filter/pagination', pagination)
applicationRouter.post('/filter/add', verifyToken, checkRole('admin'), addFilter)
applicationRouter.put('/filter/update/:id', verifyToken, checkRole('admin'), updateFilter)
applicationRouter.delete('/filter/delete/:id', verifyToken, checkRole('admin'), deleteFilter)

// ================================= refundPolicy ===================================
applicationRouter.get('/refundPolicy/getOne/:id', getAllRefundPolicy)
applicationRouter.get('/refundPolicy/getAll', getAllRefundPolicy)
applicationRouter.get('/refundPolicy/single', getSingleRefundPolicy)
applicationRouter.post('/refundPolicy/add', verifyToken, checkRole('admin'), addRefundPolicy)
applicationRouter.put('/refundPolicy/update/:id', verifyToken, checkRole('admin'), updateRefundPolicy)
applicationRouter.delete('/refundPolicy/delete/:id', verifyToken, checkRole('admin'), deleteRefundPolicy)


// ================================= term ===================================
applicationRouter.get('/term/getOne/:id', getAllTerms)
applicationRouter.get('/term/getAll', getAllTerms)
applicationRouter.get('/term/single', getSingleTerms)
applicationRouter.post('/term/add', verifyToken, checkRole('admin'), addTerms)
applicationRouter.put('/term/update/:id', verifyToken, checkRole('admin'), updateTerms)
applicationRouter.delete('/term/delete/:id', verifyToken, checkRole('admin'), deleteTerms)
